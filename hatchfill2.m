...
% 1. retrieve face & vertex matrices from A
[V,F,varargout{3:end}] = gethgdata(A);
...
function [V,F,listner_cfg] = gethgdata(A)
...
isopt = ~cellfun(@isempty,regexp(rnames,'^(Hatch|Speckle)','once'));
props = struct([]);
